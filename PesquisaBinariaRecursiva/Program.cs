using PesquisaBinariaRecursiva;
...
Console.WriteLine(BuscaBinaria.Handle(listaOrdenada, 2));
Console.WriteLine(BuscaBinaria.Handle(listaOrdenada, 2000));
Console.WriteLine("---");
Console.WriteLine(BuscaBinaria.Handle(listaOrdenada, 5));
Console.WriteLine(BuscaBinaria.Handle(listaOrdenada, 1992));
Console.WriteLine("---");
Console.WriteLine(BuscaBinaria.Handle(listaOrdenada, 701));
Console.WriteLine(BuscaBinaria.Handle(listaOrdenada, 1223));
Console.WriteLine(BuscaBinaria.Handle(listaOrdenada, 1234));
Console.WriteLine("---");
Console.WriteLine(BuscaBinaria.Handle(listaOrdenada, 1144));
Console.WriteLine("---");